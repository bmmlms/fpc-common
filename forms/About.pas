...
begin
  ...
  case AppGlobals.License of
    alGPL:
      txtAbout.Text := Format(_('%s'#13#10 + 'Copyright © 2010-2026 Alexander Nottelmann et al.'#13#10#13#10 +
    ...
    alProprietary:
    begin
      txtAbout.Text := Format(_('%s'#13#10 + 'Copyright © 2010-2026 Alexander Nottelmann'), [AppGlobals.AppName]);
